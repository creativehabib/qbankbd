...
return new class extends Migration
{
    ...
    {
        Schema::table('academic_class_question', function (Blueprint $table) {
    ...
    {
        Schema::table('academic_class_question', function (Blueprint $table) {
            $table->dropForeign('academic_class_question_academic_class_id_foreign');
            $table->dropForeign('academic_class_question_question_id_foreign');
        });
    }
};
