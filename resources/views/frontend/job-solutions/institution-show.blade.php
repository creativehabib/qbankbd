...
@section('title', $institution->name . ' এর সকল পরীক্ষার প্রশ্ন ও সমাধান')
@section('description', $institution->name . ' কর্তৃক পরিচালিত বিগত সালের সকল পরীক্ষার প্রশ্ন ও পূর্ণাঙ্গ সমাধান।')
                ...
                <div class="flex-grow w-full">
                    ...
                    <div x-data="{ expanded: false }">
                        <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-3 leading-relaxed max-w-4xl transition-all duration-300 ease-in-out overflow-hidden" :class="expanded ? 'max-h-[1000px]' : 'max-h-[46px] line-clamp-2'">
                            {{ $institution->description ?? $institution->name . ' কর্তৃক পরিচালিত বিগত সালের সকল পরীক্ষার প্রশ্ন ও সমাধান নিচে দেওয়া হলো।' }}
                        </p>
