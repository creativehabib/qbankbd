@php
    ...
    $singleItems = [
        ...
        ['label' => __('আমার তৈরি প্রশ্ন'), 'route' => 'questions.index', 'match' => 'questions.*', 'icon' => 'list-bullet', 'visible' => auth()->user()->isTeacher()],
        ...
        <nav class="relative flex-1 space-y-2 p-2" :class="sidebarCollapsed ? 'overflow-visible' : 'overflow-y-auto'" data-test="sidebar-nav">
                                ...
                                <span class="inline-flex h-4 w-4 items-center justify-center">
                                    @switch($item['icon'])
                                        ...
                                        @case('document-duplicate')
                                            ...
                                            @break
                                        @case('list-bullet')
                                            <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 6.75h12m-12 5.25h12m-12 5.25h12" /><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h.008v.008H3.75V6.75Zm0 5.25h.008v.008H3.75V12Zm0 5.25h.008v.008H3.75v-.008Z" /></svg>
                                            @break
                                        @case('book-open')
            ...
            <template x-if="sidebarCollapsed">
                <div class="space-y-2">
                    ...
                    @if(auth()->user()->isTeacher())<a href="{{ route('questions.index') }}" class="flex h-10 items-center justify-center rounded-lg {{ request()->routeIs('questions.*') ? 'bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900' : 'hover:bg-zinc-200 dark:hover:bg-zinc-800' }}" title="আমার তৈরি প্রশ্ন" wire:navigate><svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 6.75h12m-12 5.25h12m-12 5.25h12" /><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h.008v.008H3.75V6.75Zm0 5.25h.008v.008H3.75V12Zm0 5.25h.008v.008H3.75v-.008Z" /></svg></a>@endif
