        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                @if($canCreateQuestion)
                    <a wire:navigate href="{{ route('questions.bulk-upload') }}"
                       class="inline-flex items-center justify-center gap-2 px-4 py-2 border border-indigo-300 text-indigo-700 dark:text-indigo-300 dark:border-indigo-600 font-medium text-sm rounded-md hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-all">
                        Bulk Upload
                    </a>
