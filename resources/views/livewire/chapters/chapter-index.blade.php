<div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 relative">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="relative flex-1 max-w-md">
                ...
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Search chapters ..."
                       class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 text-sm" />
            </div>
            ...
            @forelse($chapters as $chapter)
                <tr class="hover:bg-indigo-50/50 dark:hover:bg-gray-700/50 transition-colors group">
                    ...
                    <td class="px-6 py-4 text-right space-x-1">
                        <button type="button" wire:click="edit({{ $chapter->id }})" wire:loading.attr="disabled"
    ...
    <div x-data="{ open: false }"
         x-show="open"
         x-on:open-chapter-modal.window="open = true"
         x-on:close-chapter-modal.window="open = false"
                    ...
                    <div class="px-6 py-6 space-y-5">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <select wire:model="subject_id" class="block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white transition-colors">
