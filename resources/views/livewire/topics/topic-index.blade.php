            ...
            @forelse($topics as $topic)
                <tr class="hover:bg-indigo-50/50 dark:hover:bg-gray-700/50 transition-colors group">
                    ...
                    <td class="px-6 py-4 text-right space-x-1">
                        ...
                        <button type="button"
                                x-data
                                x-on:click="window.confirmDeleteAction(() => $wire.delete({{ $topic->id }}))"
                ...
                <form wire:submit.prevent="save">
                    <div class="px-6 py-6 space-y-5">
                        ...
                        <div>
                            ...
                            <select wire:model.live="modalSubjectId" class="app-form-control">
                        ...
                        <div wire:key="chapter-group-{{ $modalSubjectId ?? 'empty' }}">
                            ...
                            <select wire:model="modalChapterId"
                                    class="app-form-control disabled:opacity-50"
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="name" placeholder="e.g. Newton's First Law" class="app-form-control">
